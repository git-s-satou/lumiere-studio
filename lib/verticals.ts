...
const housingJa: VerticalData = {
  ...
  benefits: [
    ...
    {
      title: "商談の切り札はUE5画質のまま",
      body: "Pixel Streaming対応で、Unreal Engine 5のフォトリアル画質のまま操作できる空間を商談ルームや住宅展示場に設置できます。集客はWeb版、クロージングはUE5画質、という使い分けが可能です。",
    },
  ],
  process: [
    {
    ...
    },
    {
      ...
      body: "ブラウザで動くインタラクティブ版、UE5画質のまま操作できるPixel Streaming版、広告・SNS向けの映像版をご要望に応じて制作します。",
    },
    {
      title: "納品・サイト組み込み",
  ...
  plans: [
    ...
    },
    {
      ...
      price: "¥2,000,000〜",
      description: "UE5画質そのままの商談用インタラクティブ空間",
      features: [
        "Unreal Engine 5のフォトリアル画質のまま自由に操作",
        "ストリーミング配信のため端末性能を問わない",
        "商談ルーム・住宅展示場・サイネージ向け",
        "昼夜切替・仕様変更・家具レイアウト変更に対応",
        "配信サーバーの構築・運用 月額¥30,000〜",
        "納期: 2〜3ヶ月",
      ],
    },
  ],
  planCta: "この内容で相談する",
  pricingNote:
    "延床面積・部屋数・仕様切替の有無により変動します。図面を拝見しての概算見積もりは無料です。映像で制作した3D空間はINTERACTIVE / PIXEL STREAMINGへそのまま流用できるため、段階的な導入も可能です。",
  faq: [
    {
    ...
    {
      q: "Pixel Streaming版はどんな仕組みですか？",
      a: "高性能サーバー側で映像を生成しブラウザへ配信するため、お客様の端末性能に関係なくUnreal Engine 5のフォトリアル画質のまま操作できます。閲覧セッションごとにサーバー費用が発生するため、商談・展示場・イベントなど場面を絞った利用に向いています（公開サイトでの常時公開にはブラウザ版INTERACTIVEをおすすめします）。",
    },
  ],
  finalCta: {
    title: "図面を1枚、お送りください",
